...
public class SiriWeatherDB {
    //数据库名
    public static final String DB_NAME = "siri_weather";

    //数据库版本
    public static final int VERSION = 1;

    private static SiriWeatherDB siriWeatherDB;

    private SQLiteDatabase db;

    //将构造方法私有化
    private SiriWeatherDB(Context context){
        SiriWeatherOpenHelper dbHelper = new SiriWeatherOpenHelper(context,DB_NAME,null,VERSION);
